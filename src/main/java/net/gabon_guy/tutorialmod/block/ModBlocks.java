...
import net.gabon_guy.tutorialmod.block.custom.MagicBlock;
import net.gabon_guy.tutorialmod.block.custom.PinkGarnetLampBlock;
...
public class ModBlocks {
    ...
    public static final Block PINK_GARNET_BUTTON = registerBlock("pink_garnet_button",
            new ButtonBlock(BlockSetType.IRON, 2, AbstractBlock.Settings.create()
                    .strength(2f).noCollision().requiresTool()));
    ...
    public static final Block PINK_GARNET_DOOR = registerBlock("pink_garnet_door",
            new DoorBlock(BlockSetType.IRON, AbstractBlock.Settings.create().strength(2f).nonOpaque().requiresTool()));
    public static final Block PINK_GARNET_TRAPDOOR = registerBlock("pink_garnet_trapdoor",
            new TrapdoorBlock(BlockSetType.IRON, AbstractBlock.Settings.create().strength(2f).nonOpaque().requiresTool()));
